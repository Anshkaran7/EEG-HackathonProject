...
const generateData = () => {
  ...
  let fp2 = 1;  // Starting value for fp2 (adjusted to be below fp1)
  ...
  for (let i = 0; i < 100; i++) {
    ...
    fp2 = Math.min(Math.max(fp2, 0), 1);  // Limit fp2 between 0 and 1 (below fp1)
  ...
  return (
    <div>
      ...
      <LineChart width={800} height={400} data={data}>
        ...
        {/* Second Line */}
        <Line type="monotone" dataKey="fp2" stroke="blue" dot={false} />
      </LineChart>
    </div>
  );
};
